...
const KIND_BY_KEY = {
  ...
  urgency: "condition",
  diarrhea: "condition",
  "blood-stool": "condition",
  bloating: "condition",
  nausea: "condition",
  mucus: "condition",
  "night-stools": "condition",
  "bathroom-trips": "condition",
  // Heart
  "bp-high": "condition",
  "bp-ok": "condition",
  "chest-pain": "condition",
  "chest-tightness": "condition",
  palpitations: "condition",
  "heart-racing": "condition",
  "shortness-of-breath": "condition",
  dizziness: "condition",
  "ankle-swelling": "condition",
  // Diabetes
  "glucose-high": "condition",
  "glucose-low": "condition",
  // Sleep apnea
  "morning-headache": "condition",
  headache: "condition",
  "daytime-tired": "condition",
  "unrefreshing-sleep": "condition",
  snoring: "condition",
  gasping: "condition",
  "dry-mouth": "condition",
  "brain-fog": "condition",
  "restless-sleep": "condition",
  naps: "condition",
  insomnia: "condition",
  observation: "meta",
};
