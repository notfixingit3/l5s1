...
// Version is the semver-ish product version (e.g. 0.0.1-beta.33).
var Version = "0.0.1-beta.33"
...
// Examples: "v0.0.1-beta.33" (local) or "v0.0.1-beta.33+167ff35" (CI).
// Version must NOT already include the commit — that produced doubled
// strings like "v0.0.1-beta.33-g167ff35+167ff35".
func String() string {
