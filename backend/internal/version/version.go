...
// Version is the semver-ish product version (e.g. 0.0.1-beta.17).
...
// Examples: "v0.0.1-beta.17" (local) or "v0.0.1-beta.17+167ff35" (CI).
// Version must NOT already include the commit — that produced doubled
// strings like "v0.0.1-beta.17-g167ff35+167ff35".
func String() string {
