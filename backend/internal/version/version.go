...
// Version is the semver-ish product version (e.g. 0.0.1-beta.22).
...
// Examples: "v0.0.1-beta.22" (local) or "v0.0.1-beta.22+167ff35" (CI).
// Version must NOT already include the commit — that produced doubled
// strings like "v0.0.1-beta.22-g167ff35+167ff35".
func String() string {
