...
// Version is the semver-ish product version (e.g. 0.0.1-beta.20).
...
// Examples: "v0.0.1-beta.20" (local) or "v0.0.1-beta.20+167ff35" (CI).
// Version must NOT already include the commit — that produced doubled
// strings like "v0.0.1-beta.20-g167ff35+167ff35".
func String() string {
