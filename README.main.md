...
| **Current beta** | [`v0.0.1-beta.24`](https://github.com/notfixingit3/l5s1/releases/tag/v0.0.1-beta.24) |
...
```bash
docker pull ghcr.io/notfixingit3/l5s1:v0.0.1-beta.24

docker run --rm -p 8080:8080 \
  -e WEBAUTHN_RP_ID=localhost \
  -e WEBAUTHN_ORIGINS=http://localhost:8080 \
  -v l5s1-data:/data \
  ghcr.io/notfixingit3/l5s1:v0.0.1-beta.24
```
