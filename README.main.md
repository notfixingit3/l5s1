...
**Current pre-release:** [`v0.0.1-beta.14`](https://github.com/notfixingit3/l5s1-4866/releases/tag/v0.0.1-beta.14) on `dev`
...
Packages: [ghcr.io/notfixingit3/l5s1-4866](https://github.com/notfixingit3/l5s1-4866/pkgs/container/l5s1)

## Develop

```bash
git clone -b dev git@github.com:notfixingit3/l5s1-4866.git
cd l5s1
make up
```

Full docs live on the [`dev` branch README](https://github.com/notfixingit3/l5s1-4866/blob/dev/README.md).
