...
| **Current beta** | [`v0.0.1-beta.31`](https://github.com/notfixingit3/l5s1/releases/tag/v0.0.1-beta.31) |
...
docker run --rm -p 8080:8080 \
  ...
  -v l5s1-data:/data \
  ghcr.io/notfixingit3/l5s1:v0.0.1-beta.31
```
